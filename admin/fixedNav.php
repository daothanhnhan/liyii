    ...
    <div class="contentFL">
        <ul class="listMenuFL">
           ...
           <!-- <li><a href="index.php?page=danh-muc-dich-vu" title=""
            ...
            <!-- tab sản phẩm -->
            <li><a href="index.php?page=san-pham-loc-moi&new=desc" title=""
            ...
            <li><a href="index.php?page=mau-sac" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Màu sắc</a>
            </li>

            <li><a href="index.php?page=loc-gia" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Lọc giá</a>
            </li>
