...
class action_page extends library{
	...
	/*--------------- Sản phẩm --------------------*/
		...
		public function addProduct(){
			...
			$in_stock = isset($_POST['in_stock']) ? $_POST['in_stock'] : '0';

			$mau_sac_id = isset($_POST['mau_sac_id']) ? $_POST['mau_sac_id'] : '0';
			$mau_sac_id = json_encode($mau_sac_id);

			$kich_co_id = isset($_POST['kich_co_id']) ? $_POST['kich_co_id'] : '0';
			$kich_co_id = json_encode($kich_co_id);
   ...
   //          }
	  ...
	  //   	if(isset($_FILES['fileUpload2']) && $_FILES['fileUpload2']['name'] != ""){
			...
			$insert = $this->Insert_1('product', 
									   ...
									   'sssssssdddsssisiiisssssssssssssssssississssii');
   ...
   //          }
			...
			if (!$this->Update_1('product',
								  ...
								  'sssssssdddsssisiiissssssssssssssssississssii')) {
