...
<form action="" method="post" enctype="multipart/form-data" id="addProduct">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <input type="text" id="title" onchange="ChangeToSlug()" class="txtNCP1"  name="product_name" required/>
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <div>
                ...
                <input type="text" class="txtNCP1" placeholder="Điều khoản dịch vụ" name="title_seo" id="title_seo"  onkeyup="countChar(this)"/>
