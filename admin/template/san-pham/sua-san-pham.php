<?php 
    ...
    /////////////////////
    $mau_sac = $action->getList('mau_sac', '', '', 'id', 'asc', '', '', '');
    $kich_co = $action->getList('kich_co', '', '', 'id', 'asc', '', '', '');
    $mau_sac_arr = json_decode($row['mau_sac_id']);
    $kich_co_arr = json_decode($row['kich_co_id']);
?>
        ...
        <div class="boxNodeContentPage">
            ...
            <div class="rowNCP">
                ...
                <div class="subColContent">
                    ...
                    <p class="titleRightNCP">In stock</p>
                    <select name="in_stock" class="txtNCP1">
                        <option value="0" <?= $row['in_stock']==0 ? 'selected' : '' ?> >Hết hàng</option>
                        <option value="1" <?= $row['in_stock']==1 ? 'selected' : '' ?> >Còn hàng</option>
                    </select>
            ...
            <div class="rowNCP">
                ...
                <div class="subColContent">
                    ...
                    <select name="mau_sac_id[]" class="txtNCP1 chosen-select" multiple="">
                        <!-- <option value="0">Chọn màu sắc</option> -->
                        <?php foreach ($mau_sac as $item) { ?>
                        <option value="<?= $item['id'] ?>" <?= in_array($item['id'], $mau_sac_arr) ? 'selected' : '' ?> ><?= $item['name'] ?></option>
                        <?php } ?>
                    </select>
                ...
                <div class="subColContent">
                    ...
                    <p class="titleRightNCP">Kích cỡ</p>
                    <select name="kich_co_id[]" class="txtNCP1 chosen-select" multiple="">
                        <!-- <option value="0">Chọn kích cỡ</option> -->
                        <?php foreach ($kich_co as $item) { ?>
                        <option value="<?= $item['id'] ?>" <?= in_array($item['id'], $kich_co_arr) ? 'selected' : '' ?> ><?= $item['name'] ?></option>
                        <?php } ?>
                    </select>
