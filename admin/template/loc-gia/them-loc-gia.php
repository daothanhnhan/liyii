<?php 
	...
	function filter_price () {
		...
		if (isset($_POST['add_filter_price'])) {
			...
			$sql = "INSERT INTO filter_price (name, value) VALUES ('$name', '$value')";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn đã thêm được một khoảng giá.\');window.location.href="index.php?page=loc-gia"</script>';
			} else {
...
<form action="" method="post" enctype="multipart/form-data">
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <input type="text" class="txtNCP1" name="value" required/>
