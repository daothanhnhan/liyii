<?php 
	...
	function kich_co ($id) {
		...
		if (isset($_POST['add_kichco'])) {
			...
			$sql = "UPDATE kich_co SET name = '$name' WHERE id = $id";
	...
	kich_co($_GET['id']);
	$info = $action->getDetail('kich_co', 'id', $_GET['id']);
?>
...
<form action="" method="post" enctype="multipart/form-data">
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            <p class="titleRightNCP">Tên kích cỡ</p>
    ...
    <button class="btn btnSave" type="submit" name="add_kichco">Lưu</button>
</form>
