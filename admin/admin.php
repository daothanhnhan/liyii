...
<?php 
  ...
  if (!isset($_GET['page'])) {
    // dong_bo();
    // $mshopkeeper->dong_bo_db();
    // $mshopkeeper->set_name_color();
  }
        ...
        <div class="coverWeb">
            ...
            if (isset($_GET["page"])) {
                switch ($_GET["page"]) {
                    ...
                    case "san-pham-loc-moi":
                        echo "<link rel='stylesheet' type='text/css' href='css/trang-noi-dung.css' />";
                        include_once("template/san-pham/san-pham-2.php");
                        break;

                    case "san-pham-loc-anh":
                        echo "<link rel='stylesheet' type='text/css' href='css/trang-noi-dung.css' />";
                        include_once("template/san-pham/san-pham-3.php");
                        break;

                    case "san-pham-loc-muc":
                        echo "<link rel='stylesheet' type='text/css' href='css/trang-noi-dung.css' />";
                        include_once("template/san-pham/san-pham-4.php");
                        break;

                    case "san-pham-loc-stock":
                        echo "<link rel='stylesheet' type='text/css' href='css/trang-noi-dung.css' />";
                        include_once("template/san-pham/san-pham-5.php");
                        break;
                    ...
                    ///////////// mau sac /////////////////
                    case "mau-sac":
                        include_once("template/mau-sac/mau-sac.php");
                        break;
                    case "sua-mau-sac":
                        include_once("template/mau-sac/sua-mau-sac.php");
                        break;
                    case "them-mau-sac":
                        include_once("template/mau-sac/them-mau-sac.php");
                        break;
                    case "xoa-mau-sac":
                        include_once("template/mau-sac/xoa-mau-sac.php");
                        break;
                    ///////////// loc gia /////////////////
                    case "loc-gia":
                        include_once("template/loc-gia/loc-gia.php");
                        break;
                    case "them-loc-gia":
                        include_once("template/loc-gia/them-loc-gia.php");
                        break;
                    case "sua-loc-gia":
                        include_once("template/loc-gia/sua-loc-gia.php");
                        break;
                    case "xoa-loc-gia":
                        include_once("template/loc-gia/xoa-loc-gia.php");
                        break;
                    ///////////// kich co /////////////////
                    case "kich-co":
