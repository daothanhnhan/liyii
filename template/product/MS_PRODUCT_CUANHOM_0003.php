    ...
    if (isset($_GET['color'])) {
        foreach ($_GET['color'] as $item) {
            ...
            if (!in_array($item, $_SESSION['color'])) {
                array_push($_SESSION['color'], $item);
            }
        }
    }
?>
...
<?php                              
    ...
    $rows = $action_product->getProductList_byMultiLevel_orderProductId($rowCat['productcat_id'],'desc',$trang,'12',$slug);//var_dump($rows);die;
...
<script type="text/javascript">
    function colorf (name) {
        ...
        var xhttp = new XMLHttpRequest();
          ...
          xhttp.open("GET", "/functions/ajax/filter_color.php?name="+name+"&page="+page, true);
          xhttp.send();
    }
    ...
    function pricef (money) {
        ...
        var xhttp = new XMLHttpRequest();
          ...
          xhttp.open("GET", "/functions/ajax/filter_price.php?money="+money+"&page="+page, true);
          xhttp.send();
    }
    ...
    function sortf (sort) {
        ...
        var xhttp = new XMLHttpRequest();
          ...
          xhttp.open("GET", "/functions/ajax/filter_sort.php?sort="+sort+"&page="+page, true);
          xhttp.send();
    }
    ...
    function sizef (size) {
        ...
        var xhttp = new XMLHttpRequest();
          ...
          xhttp.open("GET", "/functions/ajax/filter_size.php?size="+size+"&page="+page, true);
          xhttp.send();
    }
