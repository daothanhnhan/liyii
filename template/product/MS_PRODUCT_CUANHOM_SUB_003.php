<?php 
    $product_new = $action_product->getListProductNew_hasLimit(4);//var_dump($product_new);
?>
        ...
        <div class="col-md-3 col-sm-3 col-xs-6"style="padding: 0px 8px;">
            ...
            <div class="gb-product-item_cuanhom">
                ...
                <div class="gb-product-item_cuanhom-img">
                    ...
                    <a class="boxImgProductHome" href="/<?= $row['friendly_url'] ?>"><img src="/images/<?= $item['product_img'] ?>" alt="<?= $item['product_name'] ?>" class="img-responsive"></a>
