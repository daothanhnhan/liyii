...
$product_hot = $action_product->getListProductHot_hasLimit(12);
?>
<div  class="gb-product-home">
    <!--HEADER PRODUICT TOP-->
    <div class="gb-product-top">
        <h2>SẢN PHẨM HOT</h2>
        <div class="btn-xemtatca"><a href="san-pham-hot">
                    ...
                    <div class="gb-maysanxuat_cuanhom">
                        <div class="gb-product-item_cuanhom" style="margin-bottom: 33px;">
                            ...
                            <div class="gb-product-item_cuanhom-img">
                                ...
                                <a class="boxImgProductHome" href="/<?= $row['friendly_url'] ?>"><img style="height: auto;" src="/images/<?= $item['product_img'] ?>" alt="<?= $item['product_name'] ?>" class="img-responsive"></a>
                                ...
                                <div class="gb-product-item_cuanhom-text">
                                    ...
                                    <div class="box_info_product"> 
                                        <div class="box_price_product"style="">
                                            ...
                                            <!-- <span style=""><img src="/images/Capture-removebg-preview.png" alt="" style="width: 50px; "></span> -->
                                            <?php } ?>
                                ...
                                <?php } ?>
                                            <span class="price_product" style="float:right;">
                                                ...
                                                ?>
                                                <span class="dot1" style="background: <?= $mau['code'] ?>" data-toggle="tooltip" data-placement="top" title="<?= $mau['name'] ?>"></span>
                                                <?php } ?>
                                            </span>
