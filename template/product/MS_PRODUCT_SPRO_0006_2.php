...
<?php 
    $product_new = $action_product->getListProductNew_hasLimit(12);
?>
<div class="gb-product-home">
    <!--HEADER PRODUICT TOP-->
    <div class="gb-product-top">
        <h2>SẢN PHẨM MỚI VỀ</h2>
        <div class="btn-xemtatca"><a href="san-pham-moi">
                    ...
                    <div class="gb-maysanxuat_cuanhom">
                        <div class="gb-product-item_cuanhom" style="margin-bottom: 33px;">
                            ...
                            <div class="gb-product-item_cuanhom-img">
                                ...
                                <a class="boxImgProductHome" href="/<?= $row['friendly_url'] ?>"><img
                                        style="height: auto;" src="/images/<?= $item['product_img'] ?>" alt="<?= $item['product_name'] ?>"
                                ...
                                <div class="gb-product-item_cuanhom-text">
                                    ...
                                    <?php if ($in_stock==1) { ?>
                                    <img class="iconhang" src="/images/icons/iconProductSub_02.png" alt=""
                                        style="width: 66px;">
                                    <?php } else { ?>
                                    <img class="iconhang" src="/images/icons/iconProductSub_03.png" alt=""
                                        style="width: 66px;">
                                    <?php } ?>
                                    ...
                                    <div class="box_info_product">
                                        <div class="box_price_product" style="">
                                            ...
                                            <span style=""><img class='iconms'
                                                    src="/images/Capture-removebg-preview.png" alt="" style=""></span>
                                            <?php } ?>
                                            <?php if ($row['product_hot']==1) { ?>
                                            <span style=""><img class='iconms'
                                                    src="/images/Capture1-removebg-preview.png" alt="" style=""></span>
                                            <?php } ?> 
