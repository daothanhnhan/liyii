    ...
    <div class="gb-product-show">
        ...
        <div class="row">
            ...
            <div class="col-md-12  col-sm-12">
                <div class="gb-product-show_slide-three-item_01 gb-product-show_slide-three-item owl-carousel owl-theme" style="font-family: -webkit-pictograph; font-size: 19px;">
                    <?php
                    ...
                    <div class="gb-maysanxuat_cuanhom">
                        <div class="gb-product-item_cuanhom" style="margin-bottom: 33px;">
                            ...
                            <div class="gb-product-item_cuanhom-img">
                                ...
                                <a class="boxImgProductHome" href="/<?= $row['friendly_url'] ?>"><img style="height: 350px;"  src="<?= $item['Picture'] ?>" alt="<?= $item['Name'] ?>" class="img-responsive"></a>
                                        ...
                                        <div class="box_price_product">
                                            ...
                                            <span class="price_product" style="float: right;">
                                                ...
                                                foreach ($item['ListDetail'] as $item_color) { 
                                                    ...
                                                    // }
                                                    if ($item_color['Color'] != '') { 
                                                        $mau = $action->getDetail('mau_sac', 'name', $item_color['Color']);
                                                ?>
                                                <span class="dot1" style="background: <?= $mau['code'] ?>" data-toggle="tooltip" data-placement="top" title="<?= $item_color['Color'] ?>"></span>
                                                <?php } } ?>
                                            </span>
...
<script>
    $(document).ready(function () {
        $('.gb-product-show_slide-three-item_01').owlCarousel({
            loop: true,
